...
- Create on first task if it doesn't exist.
- Update on every meaningful action (task creation, completion, code change, scope shift).

**Frontend skill pairing:** All frontend/UI work must use:
